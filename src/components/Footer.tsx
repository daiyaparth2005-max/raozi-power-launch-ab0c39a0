        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <a href="https://wa.me/919119144242" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-white/80 hover:text-accent transition-colors">
