        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/about">
              <Button
                size="lg"
                className="bg-accent hover:bg-accent/90 text-white font-bold text-lg px-8 py-6 rounded-lg shadow-2xl hover:scale-105 transition-all"
              >
                Discover More
              </Button>
            </Link>
            <Link to="/distributor">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-primary font-bold text-lg px-8 py-6 rounded-lg shadow-2xl hover:scale-105 transition-all"
              >
